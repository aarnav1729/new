  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Find Out Clientele Base of Premier Energies |  Top Solar Panel Manufacturing Company in India"
        />
        <link rel="canonical" href="https://premierenergies.com/clientele" />
        <meta
          property="og:url"
          content="https://premierenergies.com/clientele"
        />
            ...
            <div className="row">
              <div className="web-container">
                ...
                <div className="content">
                  <p>
                    Premier Energies values each client relationship with
                    passion, integrity and commitment. Since our beginning in
                    1995, we have built long-lasting relationships with clients
                    by understanding their specific business needs and catering
                    to them.
                  </p>
                  <p>
                    We believe that the most valuable and productive
                    relationships are those that are built on a solid foundation
                    of trust and respect for one-another's expertise, pursuing
                    defined goals and promoting the free flow of ideas and
                    innovation.
                  </p>
                </div>
                <div className="clintellestn">
                  <div className="clintelbox">
                    <ul>
                      <li>
                        <img src={Client01} alt="img" />
                      </li>
                      <li>
                        <img src={Client02} alt="img" />
                      </li>
                      <li>
                        <img src={Client03} alt="img" />
                      </li>
                      <li>
                        <img src={Client04} alt="img" />
                      </li>
                      <li>
                        <img src={Client05} alt="img" />
                      </li>
                      <li>
                        <img src={Client06} alt="img" />
                      </li>
                      <li>
                        <img src={Client07} alt="img" />
                      </li>
                      <li>
                        <img src={Client08} alt="img" />
                      </li>
                      <li>
                        <img src={Client09} alt="img" />
                      </li>
                      <li>
                      ...
                      <li>
                        <img src={Client19} alt="img" />
                      </li>
                      <li>
                        <img src={Client20} alt="img" />
                      </li>
                      <li>
                        <img src={Client21} alt="img" />
                      </li>
                      <li>
                        <img src={Client22} alt="img" />
                      </li>
                      <li>
                        <img src={Client23} alt="img" />
                      </li>
                      <li>
                        <img src={Client24} alt="img" />
                      </li>
                    </ul>
                  </div>
                </div>
